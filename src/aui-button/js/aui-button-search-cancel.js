...
var ButtonSearchCancel = A.Base.create('btn-search-cancel', A.Base, [], {
     ...
     * @protected
     */
    TEMPLATE: '<div class="' + A.getClassName('btn-search-cancel') + '" style="padding: 5px; position: absolute; z-index: {zIndex};">' + '<i class="{iconClass}" style="vertical-align: middle"></i>' + '</div>',
